...
class  EE_Messages_Template_Pack_New_Template_Pack extends EE_Messages_Template_Pack {
	...
	public function _set_props() {
		$this->label = __('ABM Custom 01', 'event_espresso');
		$this->dbref = 'new_template_pack';
		$this->description = __('This is a new template pack customised by Andrew Miller', 'event_espresso');
		...
		$this->_supports = array(
			'email' => array(
				'cancelled_registration', 'declined_registration', 'not_approved_registration', 'pending_approval', 'registration',
					'registration_summary', 'payment_declined', 'payment', 'payment_refund', 'payment_reminder', 'newsletter', 'ticket_notice'
				),
			);
